...
import { RheoCell as BaseCell, TraceResult, Signal, MeshError } from "./core";
import type {
    Router,
    Procedure,
    InferInput,
    ...
    */
    async askMesh<TCapability extends ValidCapability>(
        ...
        while (Date.now() - startTime < timeout) {
            const result = await super.askMesh(capability as string, input);
...
export class CapabilityValidator {
    ...
    static async validateMesh(cell: TypedRheoCell): Promise<{
        ...
        const healthResult = await cell.askMesh("mesh/health" as ValidCapability, {});
